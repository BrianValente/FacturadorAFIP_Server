/* afipLoginCmsSoapBindingProxy.cpp
...
#include "afipLoginCmsSoapBindingProxy.h"
...
int LoginCmsSoapBindingProxy::send_loginCms(const char *soap_endpoint_url, const char *soap_action, _ns1__loginCms *ns1__loginCms)
{
	struct __ns2__loginCms soap_tmp___ns2__loginCms;
	...
	if (soap_action == NULL)
		soap_action = "";
	soap_tmp___ns2__loginCms.ns1__loginCms = ns1__loginCms;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___ns2__loginCms(soap, &soap_tmp___ns2__loginCms);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns2__loginCms(soap, &soap_tmp___ns2__loginCms, "-ns2:loginCms", "")
...
int LoginCmsSoapBindingProxy::recv_loginCms(_ns1__loginCmsResponse &ns1__loginCmsResponse)
{
	ns1__loginCmsResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns1__loginCmsResponse.soap_get(soap, "ns1:loginCmsResponse", NULL);
	if (soap->error)
